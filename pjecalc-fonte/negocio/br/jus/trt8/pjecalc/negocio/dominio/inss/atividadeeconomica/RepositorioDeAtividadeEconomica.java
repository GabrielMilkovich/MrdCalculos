...
@Name(value="repositorioDeAtividadeEconomica")
public class RepositorioDeAtividadeEconomica
extends RepositorioBase<AtividadeEconomica> {
    public RepositorioDeAtividadeEconomica() {
