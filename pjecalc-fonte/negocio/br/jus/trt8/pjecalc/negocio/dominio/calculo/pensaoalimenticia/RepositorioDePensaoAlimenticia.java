...
@Name(value="repositorioDePensaoAlimenticia")
public class RepositorioDePensaoAlimenticia
extends RepositorioBase<PensaoAlimenticia> {
    public RepositorioDePensaoAlimenticia() {
