...
public class CartaoDePontoDiarioReportDesign {
    private static final Integer INDICE_INICIO_VALORES_APURADOS = 3;
    private static final Integer INDICE_FIELD_DIA = 2;
    private static final Integer INDICE_FIELD_FREQUENCIA = 3;
    private static final String FIELD_COMPETENCIA = "competencia";
    private static final String FIELD_DIA = "dia";
    private static final String FIELD_FREQUENCIA = "frequencia";
    ...
    private static final int QTD_COLUNAS_FIXAS = 3;
    ...
    private int maiorQtdJornada = 0;

    public JasperDesign getDesign(List<String> textosColunas, int maiorQtdJornada) throws JRException {
        this.possuiMuitasColunas = textosColunas.size() > 18;
        this.maiorQtdJornada = maiorQtdJornada;
        ...
        this.adicionarField(FIELD_DIA, String.class, this.jasperDesign);
        this.adicionarField(FIELD_FREQUENCIA, String.class, this.jasperDesign);
        for (int i = INDICE_INICIO_VALORES_APURADOS.intValue(); i <= textosColunas.size() - 1; ++i) {
    ...
    private void configurarDetalhesColunas(List<String> textosColunas, int[] tamanhos) {
        ...
        for (int i = 0; i < textosColunas.size(); ++i) {
            ...
            textField.setY(COLUMN_HEIGHT * (linha - 1));
            ...
            } else if (i + 1 == INDICE_FIELD_DIA) {
                expression.setText("$F{dia}");
            } else if (i + 1 == INDICE_FIELD_FREQUENCIA) {
                expression.setText("$F{frequencia}");
            } else {
    ...
    private int[] configurarColumnHeader(List<String> textosColunas) {
        ...
        staticText.setText("OCORR\u00caNCIAS DO CART\u00c3O DE PONTO DI\u00c1RIO");
        staticText.setHorizontalAlignment(HorizontalAlignEnum.CENTER);
    ...
    private int calcularQuantidadeDeLinhasPorRegistro(int registros, int colWidth) {
        ...
        double value = (double)(registros - 3) / qtdDinamica;
    ...
    private void configurarTitle(JasperDesign jasperDesign) {
        ...
        staticText.setText("Cart\u00e3o de Ponto Di\u00e1rio");
    ...
    private int[] getTamanhosColunas(int numeroColunas, int espacoTotal) {
        ...
        int descontarColunasFixas = 210;
        Double tamanhoColuna = (double)(espacoTotal - descontarColunasFixas) / (double)(numeroColunas - 3);
        int soma = 0;
        for (int i = 0; i < numeroColunas - 3; ++i) {
    ...
    private JRDesignStyle getZebraCellStyle() {
        if (this.zebraCellStyle == null) {
            ...
            this.zebraCellStyle.setName("zebraCellStyle");
