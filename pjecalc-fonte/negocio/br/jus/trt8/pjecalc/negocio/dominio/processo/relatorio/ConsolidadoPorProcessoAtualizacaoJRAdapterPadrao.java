...
import br.jus.trt8.pjecalc.negocio.dominio.processo.relatorio.ConsolidadoPorProcessoAtualizacaoJRAdapter;
import br.jus.trt8.pjecalc.negocio.dominio.processo.relatorio.resumo.ResumoPorProcessoAtualizacaoJRAdapter;
import br.jus.trt8.pjecalc.negocio.dominio.processo.relatorio.resumo.ResumoPorProcessoAtualizacaoJRAdapterPadrao;
...
public class ConsolidadoPorProcessoAtualizacaoJRAdapterPadrao
extends ConsolidadoPorProcessoAtualizacaoJRAdapter {
    private List<Calculo> calculos;
    private ResumoPorProcessoAtualizacaoJRAdapter resumoAtualizacao;

    public ConsolidadoPorProcessoAtualizacaoJRAdapterPadrao() {
    }

    public ConsolidadoPorProcessoAtualizacaoJRAdapterPadrao(List<Calculo> calculos) {
        this.calculos = new ArrayList<Calculo>();
        for (Calculo calculo : calculos) {
            this.calculos.add((Calculo)calculo.restaurar());
        }
        this.resumoAtualizacao = new ResumoPorProcessoAtualizacaoJRAdapterPadrao(this.calculos);
    }
    ...
    @Override
    public ResumoPorProcessoAtualizacaoJRAdapter getResumoAtualizacao() {
        return this.resumoAtualizacao;
    }
}
