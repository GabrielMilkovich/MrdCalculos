// scripts/gen-ontologia-v2-from-v1.ts
//
// Regenera supabase/functions/_shared/holerite-mapper-v2/ontologia-v2.json
// a partir de duas fontes:
//   1. ONTOLOGIA V1 (curado pelo escritório, com sinônimos + observacao_juridica)
//   2. ontologia-v2-overrides.json (renames, regras por categoria, aliases extra)
//
// USO:
...
} from '../supabase/functions/_shared/ontologia-rubricas/index.ts';
...
function main(): void {
  ...
  const seed = {
    ...
    source:
      'scripts/gen-ontologia-v2-from-v1.ts a partir de supabase/functions/_shared/ontologia-rubricas/index.ts (V1) + scripts/ontologia-v2-overrides.json',
    categorias,
