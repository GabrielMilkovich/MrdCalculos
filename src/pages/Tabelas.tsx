...
const TABELA_CONFIG: Record<string, { title: string; description: string; slug: string }> = {
  ...
  "pisos-salariais": { title: "Pisos Salariais", description: "Pisos salariais por categoria/UF", slug: "pisos_salariais" },
  ...
  "vale-transporte": { title: "Vale-transporte", description: "Tabela de tarifas e linhas de vale-transporte", slug: "vale_transporte" },
  ...
  "custas-judiciais": { title: "Custas Judiciais", description: "Custas judiciais por vigência", slug: "custas_judiciais" },
