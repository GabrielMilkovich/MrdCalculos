...
const INPC_MONTHLY: Record<number, number[]> = {
  2015: [1.48, 0.61, 1.51, 0.71, 0.99, 0.77, 0.58, 0.25, 0.51, 0.77, 1.11, 0.94],
  ...
  2018: [0.23, 0.18, 0.07, 0.21, 0.43, 1.43, 0.25, -0.03, 0.30, 0.40, -0.25, 0.14],
  2019: [0.36, 0.54, 0.77, 0.53, 0.15, -0.01, 0.10, 0.11, -0.05, 0.04, 0.14, 1.22],
  2020: [0.19, 0.17, 0.18, -0.23, -0.38, 0.26, 0.36, 0.28, 0.87, 0.89, 0.95, 1.46],
  2021: [0.67, 0.82, 0.86, 0.38, 0.96, 0.60, 1.02, 0.88, 1.20, 1.16, 0.89, 0.73],
  2022: [0.67, 1.00, 1.71, 1.04, 0.45, 0.62, -0.60, -0.31, -0.37, 0.47, 0.38, 0.46],
  2023: [0.53, 0.60, 0.56, 0.47, 0.36, -0.10, 0.07, -0.09, 0.11, 0.12, 0.07, 0.55],
  2024: [0.57, 0.81, 0.19, 0.37, 0.25, 0.25, 0.01, -0.14, 0.48, 0.61, 0.33, 0.48],
  2025: [0.00, 1.48, 0.51, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48, 0.48],
};
