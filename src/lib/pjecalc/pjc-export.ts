/**
 * ⚠️ DEPRECATED — JSON-based .PJC format (MRDcalc-PJC).
 * This is NOT the real PJe-Calc format. The canonical format uses XML with <Calculo> root.
 * Use exportPJCXml() from pjc-xml-real.ts for real PJC interop.
 * 
 * This file is kept for backward compatibility with existing .PJC files 
 * generated by earlier MRDcalc versions.
 * 
