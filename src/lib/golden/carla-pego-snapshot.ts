/**
 * GROUND TRUTH SNAPSHOT — Carla Pego vs [Reclamado]
 * Fonte: Arquivo .PJC real (carla-pego.pjc)
...
export interface CarlaPegoGoldenSnapshot {
  meta: {
    reclamante: string;
    reclamado: string;
    cpf: string;
...
// Placeholder — will be populated from extract test output
export const CARLA_PEGO_SNAPSHOT: CarlaPegoGoldenSnapshot = {
  meta: {
    reclamante: 'CARLA PEGO',
    reclamado: '',
    cpf: '',
    cnpj: '',
    admissao: '',
