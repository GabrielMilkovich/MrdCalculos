/**
 * GROUND TRUTH SNAPSHOT — Tiago José Pereira da Silva
 * Fonte: Arquivo .PJC real (tiago-jose.pjc)
...
export interface TiagoJoseGoldenSnapshot {
  meta: {
    reclamante: string;
    reclamado: string;
    cpf: string;
...
// Placeholder
export const TIAGO_JOSE_SNAPSHOT: TiagoJoseGoldenSnapshot = {
  meta: {
    reclamante: 'TIAGO JOSE PEREIRA DA SILVA',
    reclamado: '',
    cpf: '',
    cnpj: '',
    admissao: '',
